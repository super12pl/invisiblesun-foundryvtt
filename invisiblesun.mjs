...
$("head").append($("<script type = 'text/javascript'></script>").attr("src", 'https://code.jquery.com/jquery-3.7.1.js'));
$("head").append($("<script type = 'text/javascript'></script>").attr("src", 'https://code.jquery.com/ui/1.14.2/jquery-ui.js'));
